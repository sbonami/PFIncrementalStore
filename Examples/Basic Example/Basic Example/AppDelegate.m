...
- (NSManagedObjectModel *)managedObjectModel
{
    if (_managedObjectModel == nil) {
        return [BEIncrementalStore model];
    }
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Basic_Example.sqlite"];
    
    NSError *error = nil;
    _persistentStoreCoordinator = [[NSPersistentStoreCoordinator alloc] initWithManagedObjectModel:[self managedObjectModel]];
    
    PFIncrementalStore *incrementalStore = (PFIncrementalStore *)[_persistentStoreCoordinator addPersistentStoreWithType:[BEIncrementalStore type]
